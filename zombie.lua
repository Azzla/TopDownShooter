...
--zomAssets.bloodParticle = love.graphics.newImage('sprites/pFX/particle1.png')
...
function spawnZombie()
  ...
  zombie.speedMax = 7 + math.random(0,round.difficulty/4)
  zombie.speedMin = 3 + math.random(0,round.difficulty/4)
  zombie.speed = zombie.speedMin
  zombie.spawn = math.random(280,500)
  zombie.damage = 15
  ...
  zombie.goldSpawn = 8
  zombie.health = 19 * (1+math.ceil(round.difficulty/2))
  ...
  --zombie.p = {}
  --table.insert(zombie, spawnBloodParticleSystem(zombie.x, zombie.y, zombie.p))
...
function spawnBigZombie()
  ...
  zombie.speedMin = 5
  zombie.speedMax = 10 + math.random(0,round.difficulty/2)
  zombie.speed = zombie.speedMin
...
function spawnSmallZombie()
  ...
  zombie.speedMin = 4 + math.random(0,round.difficulty/4)
    ...
    for i,z in ipairs(zombies) do
      ...
      if z.hitRadius == 15 then
        ...
        if z.health < z.healthBar.totalHealth then
          z.health = z.health + (z.healthBar.totalHealth+round.difficulty*5)/1250
        end
      end
