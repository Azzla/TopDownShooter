...
guns.railgun.sound = soundFX.sniper
guns.railgun.offsX = -1
guns.railgun.offsY = 15
guns.railgun.bulletOffsX = 5
guns.railgun.bulletOffsY = -14
guns.railgun.dmg = 100 + guns.railgun.upgrades.dmg
guns.railgun.falloff = .027 -- lower is faster falloff
guns.railgun.critChance = 0.00
guns.railgun.v = 100 + guns.railgun.upgrades.v
guns.railgun.knockback = 0
guns.railgun.slowdown = 0
guns.railgun.currAmmo = 200
guns.railgun.clipSize = 4 + guns.railgun.upgrades.clipSize
guns.railgun.reload = 4
guns.railgun.cooldown = 2.0 / guns.railgun.upgrades.cooldown
guns.railgun.pierce = 100
guns.railgun.spread = player_angle
guns.railgun.zoomFactor = 4
