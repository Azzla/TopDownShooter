...
guns.pistol.knockback = .3 --1 is no effect
guns.pistol.slowdown = 0.95 --1 is no effect
...
guns.autoshotgun.dmg = 7 + guns.autoshotgun.upgrades.dmg
...
guns.autoshotgun.clipSize = 20 + guns.autoshotgun.upgrades.clipSize
guns.autoshotgun.bullets = 12 + guns.autoshotgun.upgrades.bullets
guns.autoshotgun.reload = 2.3 * guns.autoshotgun.upgrades.reload
